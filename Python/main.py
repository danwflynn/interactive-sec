...
#Need to call create function for selected shape and figure out how to make the height and width
# Be user selected and the color of shape be the shapeFill
    canvas.create_oval(10 + width/2, 10 + width, 80, 80, fill=shapeFill)
...
# Tool 12 - Create Shape
dimentionButton = Button(
    holder, text="Create", height=1, width=12, command=shapeCreate
)
dimentionButton.grid(row=4, column=4)
